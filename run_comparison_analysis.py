...
def main_analysis(folders, plot=False):
    ...
    compare_init_generation_similarity_evolution(data, plot, saving_folder)

    compare_within_generation_similarity_evolution(data, plot, saving_folder)

    compare_successive_generations_similarities(data, plot, saving_folder)

    compare_positivity_evolution(data, plot, saving_folder)

    compare_subjectivity_evolution(data, plot, saving_folder)

    # Compute creativity at the end because it takes more time 
    for folder in folders:
        print(f"Computing creativity for {folder} ...")
        creativities = compute_creativity_indexes(data[folder]['stories'])

        data[folder]['creativities'] = creativities

    compare_creativity_evolution(data, data, saving_folder)
...
if __name__ == "__main__":
    ...
    main_analysis(dirs_list, args.plot)