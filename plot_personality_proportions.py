from llm_culture.analysis.proportion_plots import *
...
def main_analysis(folders, plot, scale_y_axis, labels, sizes):
    ...
    compare_init_generation_similarity_proportion(data, plot, sizes, saving_folder, scale_y_axis)
    compare_within_gen_similarity_proportion(data, plot, sizes, saving_folder, scale_y_axis)
    compare_successive_similarity_proportion(data, plot, sizes, saving_folder, scale_y_axis)
    compare_positivity_proportion(data, plot, sizes, saving_folder, scale_y_axis)
    compare_subjectivity_proportion(data, plot, sizes, saving_folder, scale_y_axis)
    compare_creativity_proportion(data, plot, sizes, saving_folder, scale_y_axis)
...
# dirs = ['fully_connected_10_agents_10_timesteps_prop_creative_1', 'fully_connected_10_agents_10_timesteps_prop_creative_2', 'fully_connected_10_agents_10_timesteps_prop_creative_3', 'fully_connected_10_agents_10_timesteps_prop_creative_4', 'fully_connected_10_agents_10_timesteps_prop_creative_5', 'fully_connected_10_agents_10_timesteps_prop_creative_6', 'fully_connected_10_agents_10_timesteps_prop_creative_7']
# # dirs = [fully_connected_10_agents_10_timesteps_prop_creative_0+fully_connected_10_agents_10_timesteps_prop_creative_1+fully_connected_10_agents_10_timesteps_prop_creative_2+fully_connected_10_agents_10_timesteps_prop_creative_3+fully_connected_10_agents_10_timesteps_prop_creative_4+fully_connected_10_agents_10_timesteps_prop_creative_5+fully_connected_10_agents_10_timesteps_prop_creative_6+fully_connected_10_agents_10_timesteps_prop_creative_7]
# dirs_list = [f"Results/{dir_name}" for dir_name in dirs]
# sizes = {'ticks': 16,
#                   'labels': 18,
#                   'legend': 16,
#                   'title': 23,
...
# main_analysis(dirs_list, True, True, labels , sizes)
