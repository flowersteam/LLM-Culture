...
## CONSTANTS
n_timesteps = 50    
access_url = 'https://commentary-pain-mortgages-rolled.trycloudflare.com'
...
for n_agents in n_agents_var:
    for (prompt_init, prompt_update) in prompts_var:
        print(prompt_init, prompt_update)
...
n_timesteps = 50
prompt_init = 'Darwinism inspiration'
prompt_update = 'inspiration_multi'
network_structure_type = 'fully_connected'
n_seeds = 4
n_cliques = 1
n_edges = (n_agents ** 2) // 2
...
personality_list = ['Empty'] * n_agents
output_folder_path = "DarwinismInspiration_2Agents_50gen_Mistral_7b_Instruct"
