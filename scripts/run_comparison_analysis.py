...
from llm_culture.analysis.comparison_plots import (
    ...
    compare_positivity_evolution, 
    compare_subjectivity_evolution,
    compare_creativity_evolution
)
...
def run_comparison_analysis(folders, plot, scale_y_axis, labels, sizes):
    """Run the comparison analysis on the stories generated by the simulation between different folders

    :param folders: list of folders containing the stories
    :param plot: wether to plot or not
    :param scale_y_axis: scale the y axis or not
    :param labels: labels for the different folders
    :param sizes: font_size for the plots
    """
